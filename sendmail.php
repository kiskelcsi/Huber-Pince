<?php
    ...
    // Recaptcha settings
    $use_recaptcha = false;
    define("RECAPTCHA_V3_SECRET_KEY", '6Lc_A-cZAAAAAI2EkfZezJmx_CjOGv_UaJGMwg0g');
    ...
    if( count($serverErrors) > 0 ) {
        ...
        */
        ...
        $message .= '<p style="color: #999999; font-size: 11px; margin-top: 50px;"> Powered by <a href="https://slidesigma.com" style="color: #EB3B5B">Simple AJAX Contact Form</a></p>';
        $message .= '</body></html>';
